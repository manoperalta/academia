...
from .forms import FichaSaudeForm, UsuarioForm, UsuarioProfileForm
from .models import FichaSaude, Usuario
...
def complete_profile(request):
    ...
    return render(
        request, "usuarios/complete_profile.html", {"form": form, "ficha_form": ficha_form}
    )
...
def ficha_saude_detail(request, pk):
    ...
    if usuario.data_nasc:
        ...
        idade = (
            ...
            - ((today.month, today.day) < (usuario.data_nasc.month, usuario.data_nasc.day))
        )

    return render(
        request,
        "usuarios/ficha_saude_detail.html",
        {"form": form, "usuario": usuario, "idade": idade},
    )
