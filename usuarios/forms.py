    ...
    class Meta:
        ...
        widgets = {
            "altura": forms.NumberInput(
                attrs={"class": "form-control", "step": "0.01", "placeholder": "Ex: 1.75"}
            ),
            "peso": forms.NumberInput(
                attrs={"class": "form-control", "step": "0.01", "placeholder": "Ex: 70.5"}
            ),
            ...
            "usa_medicamento": forms.CheckboxInput(
                attrs={"class": "form-check-input", "id": "usa_medicamento"}
            ),
            "qual_medicamento": forms.TextInput(
                attrs={"class": "form-control", "id": "qual_medicamento_input"}
            ),
        }
