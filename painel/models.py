...
class Painel(TenantModel):
    nome = models.CharField(
        max_length=200, verbose_name="Nome do Painel", default="Painel de Aulas"
    )
    ...
    responsavel = models.ForeignKey(
        ...
        related_name="paineis_criados",
    )
    numero_de_user = models.PositiveIntegerField(
        verbose_name="Capacidade de Alunos",
        null=True,
        blank=True,
