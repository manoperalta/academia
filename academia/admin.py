...
class ConfiguracaoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Gerais", {"fields": ("titulo", "endereco", "numero", "cep", "cnpj", "ie")}),
        (
            "Aparência",
            {"fields": ("theme_mode",), "description": "Configure o tema visual do sistema"},
        ),
        (
            "Alertas Financeiros",
            {
        ...
        (
            ...
            {"fields": ("mensagem_aniversario",), "classes": ("collapse",)},
        ),
    )
